...
export const Navbar = () => {
  ...
  return (
    <div className='flex absolute top-0 bg-white text-black font-circular  z-30 w-full flex-row justify-between  min-[1200px]:px-[100px] px-[50px] items-center h-[50px]  min-[1200px]:h-[82px] '>
        ...
        <ul className='flex max-[600px]:hidden flex-row items-center min-[1200px]:gap-10  gap-3 text-[18px] leading-[22px] font-circular font-bold bg-white '>
            <li>Destination</li>
            <li>Deal</li>
            <li>Explore</li>
            <li>Resources</li>
...
{    isOpen && <ul className='flex absolute items-start  top-10  right-0 m-2 min-[600px]:hidden flex-col  justify-center   gap-3 min-[400px]:text-[18px] text-[14px]   backdrop-blur-lg  leading-[22px] font-circular font-normal  bg-graident-to-r font-bold from-white to-transparent '>

  ...
  return (
    <div className={twMerge('flex w-screen   h-fit flex-col items-center justify-start  min-[700px]:pt-[150px] pt-[100px] ',className?className:'')}>
        ...
        w-fit self-center justify-self-center text-center tracking-tight min-[1200px]:text-[80px] max-[700px]:text-[40px] text-[60px] font-circular font-extrabold'>
            ...
            {/* top */}
            <p 
            className={twMerge(`absolute min-[1200px]:-top-20 min-[700px]:-top-14 right-1/3  max-[700px]:text-[100px] flex min-[1200px]:text-[200px] 
                max-[700px]:-top-10
        ...
        <div className='flex w-full items-center justify-center '>
            <div className='flex  text-wrap max-[700px]:w-[90%] w-[60%]  tracking-wider text-center p-1 font-circular font-normal  min-[1200px]:text-[26px] text-[20px] leading-[32px] 
            mt-[32px]  mb-[90px]
            max-[700px]:text-[13px]  max-[700px]:tracking-normal max-[700px]:leading-[20px]'>
                {text}
            </div>
        </div>
        {/* children */}
